...
//bevel_gear(number_of_teeth=20,cone_distance=100,face_width=15,outside_circular_pitch=500);
module bevel_gear (
    number_of_teeth=11,
    cone_distance=100,
    face_width=20,
    ...
    finish = -1)
{
  ...
  difference ()
  {
    ...
    translate ([0,0,pitch_apex - apex_to_apex]) motorShaft(h=apex_to_apex);
